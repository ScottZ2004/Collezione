  ...
  if (dropDownIsActive) {
    arrowSVG = (
      <svg
        ...
        width="14.871"
        height="8.503"
        viewBox="0 0 14.871 8.503"
      >
        <path
          id="Icon_ionic-ios-arrow-down"
          data-name="Icon ionic-ios-arrow-down"
          d="M13.626,17.186l5.623-5.627a1.058,1.058,0,0,1,1.5,0,1.072,1.072,0,0,1,0,1.505L14.379,19.44a1.061,1.061,0,0,1-1.466.031L6.5,13.068A1.063,1.063,0,1,1,8,11.563Z"
          transform="translate(21.059 19.749) rotate(180)"
          fill="#fff"
        />
      </svg>
    );

    let dropDownItemsToBeRendered = props.dropDownItems.map((item) => {
      if (item === language) {
        return (
          <li className="footer__dropdown__listItem footer__dropdown__listItem--active">
            {item}
          </li>
        );
      } else {
        return (
          <li onClick={setLanguage} className="footer__dropdown__listItem">
            {item}
          </li>
        );
      }
    ...
    dropDownMenu = (
      <div className="footer__dropdown__listContainer">
        <ul className="footer__dropdown__list">{dropDownItemsToBeRendered}</ul>
      </div>
    );
  } else {
    arrowSVG = (
            ...
            >
              ...
              >
                ...
                <path
                  ...
                  d="M15.139,15.206l.751-4.892H11.2V7.139A2.446,2.446,0,0,1,13.954,4.5h2.134V.331A26.026,26.026,0,0,0,12.3,0C8.434,0,5.907,2.343,5.907,6.585v3.729h-4.3v4.892h4.3V27.034H11.2V15.206Z"
                  transform="translate(85.151 24.483)"
                  fill="#413d45"
                />
              </g>
            </svg>
            ...
            >
              ...
              >
                ...
                <path
                  ...
                  d="M20.651,2.25H1.584A1.6,1.6,0,0,0,0,3.853V22.886a1.6,1.6,0,0,0,1.584,1.6H20.651a1.6,1.6,0,0,0,1.589-1.6V3.853A1.6,1.6,0,0,0,20.651,2.25ZM6.721,21.312h-3.3V10.7h3.3V21.312ZM5.073,9.249A1.911,1.911,0,1,1,6.985,7.338,1.912,1.912,0,0,1,5.073,9.249Zm14,12.063h-3.3V16.15c0-1.231-.025-2.815-1.713-2.815-1.718,0-1.981,1.34-1.981,2.725v5.252h-3.3V10.7h3.162v1.45H12a3.472,3.472,0,0,1,3.122-1.713c3.336,0,3.956,2.2,3.956,5.058Z"
                  transform="translate(170.88 24.63)"
                  fill="#413d45"
                />
              </g>
            </svg>
            ...
            >
              ...
              >
                ...
                <path
                  ...
                  d="M24.536,8.916c.017.243.017.486.017.729A15.838,15.838,0,0,1,8.607,25.592,15.839,15.839,0,0,1,0,23.076a11.594,11.594,0,0,0,1.353.069,11.225,11.225,0,0,0,6.958-2.395,5.615,5.615,0,0,1-5.24-3.887,7.068,7.068,0,0,0,1.059.087A5.928,5.928,0,0,0,5.6,16.76a5.606,5.606,0,0,1-4.494-5.5v-.069a5.645,5.645,0,0,0,2.533.711A5.613,5.613,0,0,1,1.909,4.4,15.932,15.932,0,0,0,13.465,10.27a6.327,6.327,0,0,1-.139-1.284,5.61,5.61,0,0,1,9.7-3.835A11.035,11.035,0,0,0,26.584,3.8,5.59,5.59,0,0,1,24.12,6.886a11.236,11.236,0,0,0,3.228-.868,12.048,12.048,0,0,1-2.811,2.9Z"
                  transform="translate(212.326 23.528)"
                  fill="#413d45"
                />
              </g>
            </svg>
            ...
            >
              ...
              >
                ...
                <path
                  ...
                  transform="translate(254.548 23.388)"
                  fill="#413d45"
                />
              </g>
            </svg>
