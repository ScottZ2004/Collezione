...
const Check = (props) => {
    return (
        <div className="check">
            <svg className="check__svg" xmlns="http://www.w3.org/2000/svg" width="36" height="26.846" viewBox="0 0 36 26.846">
            ...
            <p className="check__p">{props.title || "Dit is inbegrepen!"}</p>
        </div>
    );
}
