...
const Signup = (props) =>{
    ...
    const onSubmitButtonClick = (e) => {
        e.preventDefault()
        if (signupValues.password === "" || signupValues.email === "" || signupValues.firstName === "" || signupValues.lastName === ""){
            setWrongInput(true)
        }else{
            addUser(signupValues.lastName, signupValues.firstName, signupValues.email, signupValues.password);
        }
    }

    
    let wrongInputToBeRendered = null;
    if (wrongInput){
        wrongInputToBeRendered = ( <p className="signup__text__wrong">Je bent een veld vergeten in te vullen</p>)
    }
    ...
    return(
        <>
            ...
            <section className="signup">
                <figure className="signup__svgContainer">
                ...
                <section className="signupWrapper">
                    <form onSubmit={onSubmitButtonClick} className="signup__form" action="">
                        ...
                        <div className="signup__inputContainer">
                            <div className="signup__inputWrapper">
                                <input onChange={onInputChange} placeholder="firstName"  id="firstName" className="signup__input" type="text"/>
                                <label className="signup__label" htmlFor="firstName">First name*</label>
                            </div>
                        </div>
                        <div className="signup__inputContainer">
                            <div className="signup__inputWrapper">
                                <input onChange={onInputChange} placeholder="lastName"  id="lastName" className="signup__input" type="text"/>
                                <label className="signup__label" htmlFor="lastName">Last name*</label>
                            </div>
                        </div>
                        <div className="signup__inputContainer">
                            <div className="signup__inputWrapper">
                                <input onChange={onInputChange} placeholder="email"  id="email" className="signup__input" type="email"/>
                                <label className="signup__label" htmlFor="email">Email address*</label>
                            </div>
                        </div>
                        <div className="signup__inputContainer">
                            <div className="signup__inputWrapper">
                                <input onChange={onInputChange} type={passwordType} id="password" className="signup__input"  placeholder="password"/>
